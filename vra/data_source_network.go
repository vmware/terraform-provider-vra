...
func dataSourceNetworkRead(d *schema.ResourceData, meta interface{}) error {
	...
	d.SetId(*net.ID)
	_ = d.Set("cidr", net.Cidr)
	_ = d.Set("cloud_account_ids", net.CloudAccountIds)
	_ = d.Set("created_at", net.CreatedAt)
	_ = d.Set("custom_properties", net.CustomProperties)
	_ = d.Set("deployment_id", net.DeploymentID)
	_ = d.Set("description", net.Description)
	_ = d.Set("external_id", net.ExternalID)
	_ = d.Set("external_region_id", net.ExternalRegionID)
	_ = d.Set("external_zone_id", net.ExternalZoneID)
	_ = d.Set("name", net.Name)
	_ = d.Set("organization_id", net.OrgID)
	_ = d.Set("owner", net.Owner)
	_ = d.Set("project_id", net.ProjectID)
	_ = d.Set("tags", net.Tags)
	_ = d.Set("updated_at", net.UpdatedAt)
