...
func dataSourceCloudAccountVsphereRead(d *schema.ResourceData, meta interface{}) error {
	...
	_ = d.Set("associated_cloud_account_ids", flattenAssociatedCloudAccountIDs(cloudAccountVsphere.Links))
	_ = d.Set("created_at", cloudAccountVsphere.CreatedAt)
	_ = d.Set("dc_id", cloudAccountVsphere.Dcid)
	_ = d.Set("description", cloudAccountVsphere.Description)
	_ = d.Set("hostname", cloudAccountVsphere.HostName)
	_ = d.Set("name", cloudAccountVsphere.Name)
	_ = d.Set("org_id", cloudAccountVsphere.OrgID)
	_ = d.Set("owner", cloudAccountVsphere.Owner)
	_ = d.Set("updated_at", cloudAccountVsphere.UpdatedAt)
	_ = d.Set("username", cloudAccountVsphere.Username)
