...
func dataSourceImageRead(d *schema.ResourceData, meta interface{}) error {
	...
	_ = d.Set("custom_properties", image.CustomProperties)
	_ = d.Set("description", image.Description)
	_ = d.Set("external_id", image.ExternalID)
	_ = d.Set("id", image.ID)
	_ = d.Set("name", image.Name)
	_ = d.Set("org_id", image.OrgID)
	_ = d.Set("os_family", image.OsFamily)
	_ = d.Set("owner", image.Owner)
	_ = d.Set("private", image.IsPrivate)
	_ = d.Set("region", image.ExternalRegionID)
