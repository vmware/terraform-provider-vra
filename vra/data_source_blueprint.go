...
func dataSourceBlueprintRead(d *schema.ResourceData, meta interface{}) error {
	...
	_ = d.Set("content", blueprintResource.Content)
	_ = d.Set("content_source_id", blueprintResource.ContentSourceID)
	_ = d.Set("content_source_pat", blueprintResource.ContentSourcePath)
	_ = d.Set("content_source_sync_at", blueprintResource.ContentSourceSyncAt)
	_ = d.Set("content_source_sync_messages", blueprintResource.ContentSourceSyncMessages)
	_ = d.Set("content_source_sync_status", blueprintResource.ContentSourceSyncStatus)
	_ = d.Set("content_source_type", blueprintResource.ContentSourceType)
	_ = d.Set("created_at", blueprintResource.CreatedAt)
	_ = d.Set("created_by", blueprintResource.CreatedBy)
	_ = d.Set("description", blueprintResource.Description)
	_ = d.Set("name", blueprintResource.Name)
	_ = d.Set("org_id", blueprintResource.OrgID)
	_ = d.Set("project_id", blueprintResource.ProjectID)
	_ = d.Set("project_name", blueprintResource.ProjectName)
	_ = d.Set("request_scope_org", blueprintResource.RequestScopeOrg)
	_ = d.Set("self_link", blueprintResource.SelfLink)
	_ = d.Set("status", blueprintResource.Status)
	_ = d.Set("total_released_versions", blueprintResource.TotalReleasedVersions)
	_ = d.Set("total_versions", blueprintResource.TotalVersions)
	_ = d.Set("updated_at", blueprintResource.UpdatedAt)
	_ = d.Set("updated_by", blueprintResource.UpdatedBy)
	_ = d.Set("valid", blueprintResource.Valid)
