...
func dataSourceStorageProfileVsphereRead(d *schema.ResourceData, meta interface{}) error {
	...
	_ = d.Set("disk_mode", storageProfile.DiskMode)
	_ = d.Set("disk_type", storageProfile.DiskType)
	_ = d.Set("external_region_id", storageProfile.ExternalRegionID)
	_ = d.Set("limit_iops", storageProfile.LimitIops)
	_ = d.Set("name", storageProfile.Name)
	_ = d.Set("org_id", storageProfile.OrgID)
	_ = d.Set("owner", storageProfile.Owner)
	_ = d.Set("provisioning_type", storageProfile.ProvisioningType)
	_ = d.Set("shares", storageProfile.Shares)
	_ = d.Set("shares_level", storageProfile.SharesLevel)
