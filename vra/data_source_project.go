...
func dataSourceProjectRead(d *schema.ResourceData, meta interface{}) error {
	...
	setFields := func(project *models.IaaSProject) {
		d.SetId(*project.ID)
		_ = d.Set("administrators", flattenUsers(project.Administrators))
		_ = d.Set("administrator_roles", flattenUsers(project.Administrators))
		_ = d.Set("constraints", flattenProjectConstraints(project.Constraints))
		_ = d.Set("custom_properties", project.CustomProperties)
		_ = d.Set("description", project.Description)
		_ = d.Set("machine_naming_template", project.MachineNamingTemplate)
		_ = d.Set("members", flattenUsers(project.Members))
		_ = d.Set("member_roles", flattenUsers(project.Members))
		_ = d.Set("name", project.Name)
		_ = d.Set("operation_timeout", project.OperationTimeout)
		_ = d.Set("placement_policy", project.PlacementPolicy)
		_ = d.Set("shared_resources", project.SharedResources)
		_ = d.Set("supervisor_roles", flattenUsers(project.Supervisors))
		_ = d.Set("viewers", flattenUsers(project.Viewers))
		_ = d.Set("viewer_roles", flattenUsers(project.Viewers))
		_ = d.Set("zone_assignments", flattenZoneAssignment(project.Zones))
	}
