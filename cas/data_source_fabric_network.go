...
func resourceFabricNetworkRead(d *schema.ResourceData, meta interface{}) error {
	log.Printf("Reading the cas_fabric_network data source with name %s", d.Get("name"))
	...
	log.Printf("Finished reading the cas_fabric_network data source with name %s", d.Get("name"))
	return nil
}
