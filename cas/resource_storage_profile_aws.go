...
func resourceStorageProfileAwsCreate(d *schema.ResourceData, m interface{}) error {
	log.Printf("Starting to create cas_aws_storage_profile resource")
	...
	log.Printf("Finished to create cas_Aws_storage_profile resource with name %s", d.Get("name"))

	return resourceStorageProfileAwsRead(d, m)
}

func resourceStorageProfileAwsRead(d *schema.ResourceData, m interface{}) error {
	log.Printf("Reading the cas_Aws_storage_profile resource with name %s", d.Get("name"))
	apiClient := m.(*Client).apiClient
	...
	log.Printf("Finished reading the cas_aws_storage_profile resource with name %s", d.Get("name"))
	return nil
}
...
func resourceStorageProfileAwsDelete(d *schema.ResourceData, m interface{}) error {
	log.Printf("Starting to delete the cas_aws_storage_profile resource with name %s", d.Get("name"))
	apiClient := m.(*Client).apiClient
	...
	d.SetId("")
	log.Printf("Finished deleting the cas_aws_storage_profile resource with name %s", d.Get("name"))
	return nil
}
